...
name = 'AM-DNA-098'
output_dir = '/Genomics/chanlab/blaw/TLS/data/AM-DNA-098/lineage/2_lineage_reconstruction/'
tree_loc = '/Genomics/chanlab/blaw/TLS/data/AM-DNA-098/lineage/2_lineage_reconstruction/AM-DNA-098_hybrid_newick_noMutationlessEdges.txt'
...
cas.pl.upload_and_export_itol(test_tree, 'TLS_120h_2_noMutationLess_final', api_key = 'FH5LLzi6mypVzMx1oYxyoA',
                              project_name = 'AM-DNA-098', export_filepath = '/Genomics/chanlab/blaw/TLS/data/AM-DNA-098/lineage/3_tree_graphs/TLS_120h_2_noMutationLess_final.pdf', 
                              meta_data = ['cluster'], palette = color_order)

cas.pl.upload_and_export_itol(test_tree, 'TLS_120h_2_noMutationLess_indels_final', api_key = 'FH5LLzi6mypVzMx1oYxyoA',
                              project_name = 'AM-DNA-098', export_filepath = '/Genomics/chanlab/blaw/TLS/data/AM-DNA-098/lineage/3_lineage_stats/TLS_120h_2_noMutationLess_indels_final.pdf', 
