...
Purpose: To run the AM-DNA-258 (TLS_TLSCL) dataset through Cassiopeia preprocessing and tree reconstruction.
...
name = 'AM-DNA-258'
genome_bam = '/Genomics/chanlab/blaw/TLS/raw_data/AM-DNA-258.bam'
output_dir = '/Genomics/chanlab/blaw/TLS/data/AM-DNA-258/lineage/1_preprocessing/'
