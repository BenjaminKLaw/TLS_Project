...
#######################################################################
name = 'AM-DNA-097'
output = '/Genomics/chanlab/blaw/TLS/data/AM-DNA-097/lineage/2_lineage_reconstruction/'
alleleTable_filepath = '/Genomics/chanlab/blaw/TLS/data/AM-DNA-097/lineage/1_preprocessing/allele_table.txt'
