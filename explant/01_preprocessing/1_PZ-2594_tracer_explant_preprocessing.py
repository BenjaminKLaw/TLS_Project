...
Purpose: To run the Tracer explant dataset that corresponds with the AM-RNA-929 and AM-DNA-341 dataset through Cassiopeia preprocessing and tree reconstruction.

The fastqs for this dataset can be found here: 
    /Genomics/chanlab/blaw/TLS/raw_data/explant/2594__Tracer_TLS_Explant__TLS_DBiT-seq_Celeste-read-1.fastq.gz
    /Genomics/chanlab/blaw/TLS/raw_data/explant/2594__Tracer_TLS_Explant__TLS_DBiT-seq_Celeste-read-3.fastq.gz
...
output_dir = "/Genomics/chanlab/blaw/TLS/sandbox/explant/1_preprocessing/PZ-2594_tracer_explant/"
...
# Raw fastq's
input_files = ["/Genomics/chanlab/blaw/TLS/raw_data/explant/2594__Tracer_TLS_Explant__TLS_DBiT-seq_Celeste-read-1.fastq.gz",
              "/Genomics/chanlab/blaw/TLS/raw_data/explant/2594__Tracer_TLS_Explant__TLS_DBiT-seq_Celeste-read-3.fastq.gz"]
